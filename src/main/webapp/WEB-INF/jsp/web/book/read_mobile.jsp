...
<head>
    ...
    <title>Books | Horaec的个人博客</title>
    <link rel="icon" href="${imageDomain}/hblog_icon.ico"/>
            ...
            <c:forEach var="bookInfoVO" items="${bookInfoVOList}" varStatus="status" >
                <div class="book">
                    ...
                    <div class="info">
                        ...
                        <div class="detail"><a href="${staticDomain}/about">Horaec</a><span><fmt:formatDate value="${bookInfoVO.createTime}" pattern="MM-dd HH:mm" /> </span></div>
