...
<div id="fix-left">
    ...
    <div class="menu_bar">
        <ul>
            ...
            <a href="javascript:void(0)"><li class="men_7">
                <a href="${staticDomain}/switch?mo=1"><i class="fa fa-moon-o" aria-hidden="true"></i></a>
                <a href="${staticDomain}/switch?mo=2"><span style="top: 365px">
                    <i class="fa fa-sun-o" aria-hidden="true"></i>
                </span></a>
            </li></a>
            <a href="${staticDomain}/#/manage"><li class="menu_6">
                <i class="fa fa-info-circle" aria-hidden="true"></i>
                <span style="top: 405px">关于</span>
            </li></a>
        </ul>
    </div>
</div>
